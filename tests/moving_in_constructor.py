...
def test_check_enter_to_constructor_from_cabinet_true():
    ...
    sauce = driver.find_element(*EnterCheckLocators.DISPLAY_BUTTON_SAUCE) #находим конструкторе кнопку раздел Соусы
    sauce.click()#нажимаем в конструкторе кнопку раздел Соусы
    bread = driver.find_element(*EnterCheckLocators.DISPLAY_BUTTON_BREAD) #находим в конструкторе кнопку раздел Булки
    bread.click()#нажимаем в конструкторе кнопку раздел Булки
    toppings = driver.find_element(*EnterCheckLocators.DISPLAY_BUTTON_TOPPINGS) #находим в конструкторе кнопку раздел Начинки
